...
class CharacterChatBot():
    ...
    def chat(self, message, history):
        ...
        messages.append({"role":"system","content":""""Your are Walter White from the TV serie "Breaking Bad". Your responses should reflect his personality and speech patterns \n"""})
